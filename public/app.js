...
var Form = exports.Form = function Form(_ref, children) {
    var title = _ref.title,
        ...
        showSubmit = _ref$showSubmit === undefined ? true : _ref$showSubmit;


    var submit = showSubmit ? (0, _hyperapp.h)(_Buttons.Button, { color: 'primary', text: buttonText }) : null;
...
var TextArea = exports.TextArea = function TextArea(_ref4, children) {
    ...
    var inputItem = void 0;
    var input = (0, _hyperapp.h)('textarea', (_h = {
        placeholder: placeholder,
        name: name,
        id: id,
        value: value,
